...
class KanTrainer:
	...
	def __init__(self, inputVariables, outputVariable, batch_size, epochs, device, test_proportion, validation_proportion, lr,
				 loss_fn,
				 validation_loss_fn):
	...
	def train(self, dataset):
		...
		return architecture, avg_loss, features
