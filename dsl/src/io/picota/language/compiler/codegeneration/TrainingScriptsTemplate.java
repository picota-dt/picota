...
public class TrainingScriptsTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(trigger("callvariable")).output(literal("print(\"Training ")).output(placeholder(new String[]{"container"}, "name")).output(literal(".")).output(placeholder("viewPoint")).output(literal(".")).output(placeholder("name")).output(literal("...\")\n")).output(placeholder(new String[]{"container"}, "name")).output(literal(".")).output(placeholder("viewPoint")).output(literal(".")).output(placeholder("name")).output(literal(".train(source, modeldir)")));
