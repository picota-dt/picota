...
import {Bell, Calendar, Check, Coins, Mail, Plus, ShieldCheck, Trash2, User} from "lucide-react";
            ...
            <div className="max-w-2xl mx-auto flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled
                                className="w-full bg-white/[0.03] border border-white/8 rounded-xl px-3.5 py-2.5 text-white/55 text-sm outline-none cursor-not-allowed"
                            />
                            <p className="text-white/25 text-xs mt-2">Managed by your Google account.</p>
                        </div>
                        <div>
                            <label
                                className="text-white/40 text-xs uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
                ...
                <div className="bg-[#1a1d27] border border-white/8 rounded-2xl p-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <div
                            className="flex items-center gap-3 w-full text-left px-4 py-3 rounded-xl bg-white/[0.03] border border-white/6">
                            <div
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-white/75 text-sm" style={{fontWeight: 500}}>Authentication
                                    provider</p>
                                <p className="text-white/30 text-xs">Google</p>
                            </div>
                        </div>
                        <div
