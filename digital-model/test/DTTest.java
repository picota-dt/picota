...
import io.picota.digitalmodel.Main;
import io.picota.digitalmodel.actions.GetStateAction;
import io.picota.digitalmodel.actions.PostDataAction;
import io.picota.digitalmodel.actions.PostStateAction;
import io.picota.digitalmodel.rest.resources.PostStateResource;
...
//		new InfecarDataToCSV(Main.class.getResourceAsStream("/infecar.jsonl"), new File("./test-res/infecar.csv")).run();
	...
	public void should_prepare_models() throws BadRequest {
		...
		changeStateAction.digitalTwin = DIGITAL_TWIN_NAME;
