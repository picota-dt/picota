...
public class PicotaApiAccessor {
	...
	public java.lang.Enum getState(String entity) throws InternalServerError {
		...
		try {
			...
			return io.intino.alexandria.restaccessor.adapters.ResponseAdapter.adapt(response.content(), java.lang.Enum.class);
	...
	public void postData(String entity, DataType type, io.intino.alexandria.Resource.InputStreamProvider data) throws BadRequest, InternalServerError {
		RequestBuilder builder = new RequestBuilder(this.url).timeOut(this.timeoutMillis);
		additionalHeaders.forEach((k, v) -> builder.headerParameter(k, v));
		RequestBuilder.Request request = builder
				.entityPart("entity", entity)
				.entityPart("type", type)
